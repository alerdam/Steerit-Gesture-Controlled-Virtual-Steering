...
def MODEL_RNN():
    model = keras.models.Sequential([
        ...
        keras.layers.Reshape((1, 8)),
        keras.layers.SimpleRNN(8, activation='tanh', return_sequences=False),
...
if loaded_data is not None:
    ...
    if xtrain is not None:
        ...
        print("")
        print("----------------------------------------------")
        print("TEST RESULTS : Time-Aware RNN Model")
        model.evaluate(xtest, ytest)

        # Save the model 
        model.save("M_timeaware_rnn.keras")
        print("Model created and saved as M_timeaware_rnn.keras")
